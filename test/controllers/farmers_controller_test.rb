...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { code: @farmer.code, name: @farmer.name, nida: @farmer.nida, parish_id: @farmer.parish_id, phone: @farmer.phone, village_id: @farmer.village_id } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { code: @farmer.code, name: @farmer.name, nida: @farmer.nida, parish_id: @farmer.parish_id, phone: @farmer.phone, village_id: @farmer.village_id } }
